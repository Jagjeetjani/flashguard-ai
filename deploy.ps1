...
# Ensure 404.html and .nojekyll exist in dist for GitHub Pages
...
git remote add origin https://github.com/Jagjeetjani/flashguard-ai.git -ErrorAction SilentlyContinue
